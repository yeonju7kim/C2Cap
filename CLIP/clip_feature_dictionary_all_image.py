...
if __name__ == '__main__':
    ...
    if args.clip_feature_hdf == None:
        ...
        args.clip_feature_hdf = f'{args.clip_feature_hdf.split(".")[0]}_aug{args.aug_num}_all_image.{args.clip_feature_hdf.split(".")[1]}'
    if args.clip_cluster_pkl == None:
        args.clip_cluster_pkl = 'clip_feature_train_cluster.pkl'
        args.clip_cluster_pkl = f'{args.clip_cluster_pkl.split(".")[0]}_k{args.k}_aug{args.aug_num}_all_image.{args.clip_cluster_pkl.split(".")[1]}'
    if args.clip_collections_pkl == None:
        args.clip_collections_pkl = 'clip_collections.pkl'
        args.clip_collections_pkl = f'{args.clip_collections_pkl.split(".")[0]}_k{args.k}_aug{args.aug_num}_all_image.{args.clip_collections_pkl.split(".")[1]}'
