...
class EncoderLayer(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        self_att = self.self_attn(x, x, x, mask)
        ...
        x = self.sublayer[0](x, lambda x:  + confounder)
...
class TransformerModel_c3cap_scaled(AttModel):
    ...
    def __init__(self, opt):
        super(TransformerModel_c3cap_scaled, self).__init__(opt)
        self.opt = opt
