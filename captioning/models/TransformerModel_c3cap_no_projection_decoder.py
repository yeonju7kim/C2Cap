...
class EncoderLayer(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        x = self.sublayer[1](x, lambda x: self.fuse_attn(x, confounder_dictionary, confounder_dictionary))
...
class DecoderLayer(nn.Module):
    ...
    def __init__(self, size, self_attn, fuse_attn, src_attn, feed_forward, dropout, c3dict):
    ...
    def forward(self, x, memory, src_mask, tgt_mask):
        ...
        x = self.sublayer[2](x, lambda x: self.fuse_attn(x, confounder_dictionary, confounder_dictionary))
...
class TransformerModel_c3cap_no_projection_decoder(AttModel):
    ...
    def make_model(self, src_vocab, tgt_vocab, N_enc=6, N_dec=6, 
        ...
        model = EncoderDecoder(
            ...
            Decoder(DecoderLayer(d_model, c(attn), c(attn), c(attn),
                                 c(ff), dropout, c3dict=self.c3dict), N_dec),
    ...
    def __init__(self, opt):
        super(TransformerModel_c3cap_no_projection_decoder, self).__init__(opt)
        print('TransformerModel_c3cap_no_projection_decoder')
        self.opt = opt
        ...
        with open(opt.clip_confounder_dictionary_path, 'rb') as f:
            print(opt.clip_confounder_dictionary_path)
